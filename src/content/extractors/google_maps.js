/**
 * Phone/address formatting is handled centrally by service-worker.js sanitizeLead().
 * No ES module imports needed — content scripts don't support them in MV3.
 */
...
class GoogleMapsExtractor {
    ...
    parseItem(item) {
        try {
            ...
            let phone = item.querySelector('button[jsaction*="phone"]')?.innerText || '';
            ...
            // Note: phone/address separation and formatting is handled by
            // service-worker.js sanitizeLead() before saving to IndexedDB.
            return {
                name,
                category,
                rating: ratingText,
